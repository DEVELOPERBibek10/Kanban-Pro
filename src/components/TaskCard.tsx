    ...
    <>
      ...
      >
        <Card
          ...
          className="w-[99%] h-[110px] max-h-[120px] flex flex-col justify-center shrink-0 gap-1.5 dark:bg-zinc-800 active:cursor-grabbing"
        >
          <CardHeader className="w-full flex items-center justify-between mb-1">
            <div
              className={cn(
           ...
           flex items-center justify-between text-[10px]`,
            ...
            >
              {task.priority === "Low" && (
                <ChevronsDown width={12} color="green" />
              )}
              {task.priority === "High" && (
                <ChevronsUp width={12} color="red" />
              )}
              {task.priority === "Medium" && (
          ...
          <CardContent>
            <span className="font-bold text-base dark:text-gray-200 line-clamp-1">
              {task.title}
            </span>
          </CardContent>
          <CardFooter>
            <span className="text-xs text-gray-600 line-clamp-1 tracking-tight dark:text-gray-500">
              {task.description}
            </span>
          </CardFooter>
        </Card>
