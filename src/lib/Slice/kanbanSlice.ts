...
export const kanbanSlice = createSlice({
  ...
  reducers: {
    ...
    updateTask: (state, action: PayloadAction<{ projectId: string, columnId: string, id: string, title: string, description?: string, priority?: TaskPriorityType, status?: TaskStatusType, createdAt?: string, updatedAt: string }>) => updateTaskReducer(state, action),
